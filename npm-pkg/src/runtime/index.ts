...
export function replaceInnerText(content: any, elm: HTMLElement) {
  elm.innerHTML = escapeHtml(content);
}

export function replaceText(content: any, elm: Node) {
  elm.textContent = escapeHtml(content);
}
