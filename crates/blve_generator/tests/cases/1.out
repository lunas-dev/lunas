...
export default function(elm) {
    ...
    elm.innerHTML = `<h1 id="abc">Hello Blve!</h1><div id="test">${escapeHtml(count.v)}</div><button id="test">+1</button><button id="test">${escapeHtml(interval.v == null ? "start" : "clear")}</button>`;
